...
class Game extends Frame implements KeyListener{
    ...
    public Game() {
        ...
        ActionListener listener = new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (!gameOver) {
                    // Increment score as the game progresses
                    score++;
    ...
    // on game over draw the game over text and score
    private void gameOver(Graphics g) {
        ...
        // Draw current score
        graph.setFont(new Font("MV Boli", 20, 30));
        graph.drawString("Score: " + score, 550, 220);

        // Draw high score
        graph.drawString("High Score: " + highScore, 550, 260);

        //restart
        Graphics2D graph1 = (Graphics2D) g;
        graph1.setPaint(colorGameOver1);
        graph1.setFont(new Font("MV Boli", 20, 30));
        graph1.drawString("Press Enter key to restart!!", 350, 320);
    }
    ...
    private void drawScore(Graphics g) {
        ...
        scoreGraph.setPaint(Color.BLACK);
        scoreGraph.setFont(new Font("MV Boli", 20, 20));
        scoreGraph.drawString("Score: " + score, 1050, 50);
    }
